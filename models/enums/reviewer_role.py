...
VICE_RECTOR_ASSISTANT_ASSISTANT = 'VICE_RECTOR_ASSISTANT_ASSISTANT'
...
ROLE_CHOICES = (
    ...
    (VICE_RECTOR_ASSISTANT_ASSISTANT, _('DAS/CAS representative'))
)

ENABLE_TO_DELEGATE = [SUPERVISION, RESEARCH, SUPERVISION_DAF, VICE_RECTOR_ASSISTANT]

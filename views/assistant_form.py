...
from assistant.forms.assistant import (
    AssistantFormPart1, AssistantFormPart3, AssistantFormPart4, AssistantFormPart5,
    AssistantFormPart6,
)
...
from base.models import person, learning_unit_year, academic_year
...
def form_part1_edit(request, msg=None):
    ...
    form = AssistantFormPart1(initial={
...
def form_part1_save(request):
    ...
    addresses = PersonAddress.objects.filter(person=pers)
...
def form_part4_edit(request):
    ...
    form = AssistantFormPart4(
        initial={
            'internships': mandate.internships,
...
def form_part6_edit(request, msg=None):
    ...
    assistant = mandate.assistant
    form = AssistantFormPart6(
        initial={
            'tutoring_percent': mandate.tutoring_percent,
...
def form_part6_save(request):
    ...
    if 'validate_and_submit' not in request.POST:
        form.save()
